...
import com.springtour.blog.demo.SpringblogApp;
import com.springtour.blog.demo.domain.Blog;
import com.springtour.blog.demo.repository.BlogRepository;
import com.springtour.blog.demo.service.BlogService;
...
@SpringApplicationConfiguration(classes = SpringblogApp.class)
@WebAppConfiguration
@IntegrationTest
public class BlogResourceIntTest {
    ...
    private static final String DEFAULT_HANDLER = "AAAAA";
    private static final String UPDATED_HANDLER = "BBBBB";
    ...
    public void initTest() {
        ...
        blog.setHandler(DEFAULT_HANDLER);
    }
    ...
    public void createBlog() throws Exception {
        ...
        assertThat(testBlog.getHandler()).isEqualTo(DEFAULT_HANDLER);
    }
    ...
    public void getAllBlogs() throws Exception {
        ...
        restBlogMockMvc.perform(get("/api/blogs?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].handler").value(hasItem(DEFAULT_HANDLER.toString())));
    }
    ...
    public void getBlog() throws Exception {
        ...
        restBlogMockMvc.perform(get("/api/blogs/{id}", blog.getId()))
            ...
            .andExpect(jsonPath("$.handler").value(DEFAULT_HANDLER.toString()));
    }
    ...
    public void updateBlog() throws Exception {
        ...
        updatedBlog.setHandler(UPDATED_HANDLER);
        ...
        assertThat(testBlog.getHandler()).isEqualTo(UPDATED_HANDLER);
    }
